...
1.  **Clone the repository:**
    ...
    ```bash
    git clone https://github.com/facudelima/suburbia-skate-main.git
    cd suburbia-skate-main
    ```
...
This repository is maintained by [facudelima](https://github.com/facudelima).
